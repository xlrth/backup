...
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
std::u8string Helpers::ReinterpretStringAsU8String(const std::string& str)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
std::string Helpers::ReinterpretU8StringAsString(const std::u8string& str)
{
    return { str.begin(), str.end() };
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
bool Helpers::CreateDirectory(const CPath& dir)
{
    std::error_code errorCode;
    ...
    {
        CLogger::GetInstance().LogWarning("cannot create directory: " + dir.string(), errorCode);
        return false;
    }
    return true;
}
